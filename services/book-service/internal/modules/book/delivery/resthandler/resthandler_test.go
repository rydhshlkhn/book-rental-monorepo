...
import (
	...
	mockusecase "monorepo/services/book-service/pkg/mocks/modules/book/usecase"
	mocksharedusecase "monorepo/services/book-service/pkg/mocks/shared/usecase"
...
func TestRestHandler_getAllBook(t *testing.T) {
	tests := []testCase{
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bookUsecase := &mockusecase.BookUsecase{}
			bookUsecase.On("GetAllBook", mock.Anything, mock.Anything).Return(
				[]domain.ResponseBook{}, candishared.Meta{}, tt.wantUsecaseError)
			mockValidator := &mockinterfaces.Validator{}
			mockValidator.On("ValidateDocument", mock.Anything, mock.Anything).Return(tt.wantValidateError)

			uc := &mocksharedusecase.Usecase{}
			uc.On("Book").Return(bookUsecase)
			...
			handler.getAllBook(res, req)
			assert.Equal(t, tt.wantRespCode, res.Code)
		})
	}
}

func TestRestHandler_getDetailBookByID(t *testing.T) {
	tests := []testCase{
		{
			name: "Testcase #1: Positive", wantUsecaseError: nil, wantRespCode: http.StatusOK,
		},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bookUsecase := &mockusecase.BookUsecase{}
			bookUsecase.On("GetDetailBook", mock.Anything, mock.Anything).Return(domain.ResponseBook{}, tt.wantUsecaseError)
			mockValidator := &mockinterfaces.Validator{}
			mockValidator.On("ValidateDocument", mock.Anything, mock.Anything).Return(tt.wantValidateError)
			...
			req.Header.Add(candihelper.HeaderContentType, candihelper.HeaderMIMEApplicationJSON)
			res := httptest.NewRecorder()
			handler.getDetailBookByID(res, req)
			assert.Equal(t, tt.wantRespCode, res.Code)
		})
	}
}

func TestRestHandler_createBook(t *testing.T) {
	tests := []testCase{
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bookUsecase := &mockusecase.BookUsecase{}
			bookUsecase.On("CreateBook", mock.Anything, mock.Anything).Return(domain.ResponseBook{}, tt.wantUsecaseError)
			mockValidator := &mockinterfaces.Validator{}
			mockValidator.On("ValidateDocument", mock.Anything, mock.Anything).Return(tt.wantValidateError)
...
func TestRestHandler_updateBook(t *testing.T) {
	tests := []testCase{
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bookUsecase := &mockusecase.BookUsecase{}
			bookUsecase.On("UpdateBook", mock.Anything, mock.Anything, mock.Anything).Return(tt.wantUsecaseError)
			mockValidator := &mockinterfaces.Validator{}
			mockValidator.On("ValidateDocument", mock.Anything, mock.Anything).Return(tt.wantValidateError)
...
func TestRestHandler_deleteBook(t *testing.T) {
	tests := []testCase{
		{
			name: "Testcase #1: Positive", wantUsecaseError: nil, wantRespCode: http.StatusOK,
		},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bookUsecase := &mockusecase.BookUsecase{}
			bookUsecase.On("DeleteBook", mock.Anything, mock.Anything).Return(tt.wantUsecaseError)
			mockValidator := &mockinterfaces.Validator{}
			mockValidator.On("ValidateDocument", mock.Anything, mock.Anything).Return(tt.wantValidateError)
