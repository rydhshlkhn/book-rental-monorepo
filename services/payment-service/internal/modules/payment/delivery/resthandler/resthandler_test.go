...
import (
	...
	mockusecase "monorepo/services/payment-service/pkg/mocks/modules/payment/usecase"
	mocksharedusecase "monorepo/services/payment-service/pkg/mocks/shared/usecase"
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			paymentUsecase.On("GetAllPayment", mock.Anything, mock.Anything).Return(
				[]domain.ResponsePayment{}, candishared.Meta{}, tt.wantUsecaseError)
			mockValidator := &mockinterfaces.Validator{}
